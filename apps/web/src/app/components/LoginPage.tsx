    ...
    <div className="min-h-[calc(100vh-64px)] bg-slate-50/50 flex flex-col items-center justify-center py-12 px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 text-sm font-medium">Login to book your favorite courts</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl shadow-slate-100/60 border border-slate-100 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="password" type={showPassword ? 'text' : 'password'} placeholder="••••••••" className="pl-10 pr-10 focus-visible:ring-emerald-500"
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-slate-500 font-medium">
              ...
              <Link to="/register" className="font-semibold text-emerald-600 hover:text-emerald-700">Register Now</Link>
            </p>
          </div>
        </div>
      </div>
