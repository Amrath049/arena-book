...
This document defines rules that ALL AI agents (Claude, Copilot, Cursor, etc.) must follow when working on this codebase. These rules exist because past violations caused data loss and unintended breaking changes.
